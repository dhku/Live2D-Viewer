...
public class AkariController : MonoBehaviour, IPacketListener
{
    ...
    void EyeBlinking()
    {
        ...
        var parameter = model.Parameters[32];
    ...
    void IrisMovement()
    {
        ...
        var parameter = model.Parameters[36]; //eye ball X
        parameter.Value = eyeball_x;
        parameter = model.Parameters[37]; //eye ball Y
    ...
    void MouthOpening()
    {
        ...
        var parameter = model.Parameters[16]; //mouth open
    ...
    void MouthForm()
    {
        ...
        var parameter = model.Parameters[17]; //mouth form
