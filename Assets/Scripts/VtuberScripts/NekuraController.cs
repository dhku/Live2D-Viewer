...
class NekuraController : MonoBehaviour, IPacketListener
{
    ...
    {
        // roll BODY Z
        var parameter = model.Parameters[5];
    ...
    void EyeBlinking()
    {
        ...
        var parameter = model.Parameters[21];
    ...
    void IrisMovement()
    {
        ...
        var parameter = model.Parameters[24]; //eye ball X
        parameter.Value = eyeball_x;
        parameter = model.Parameters[25]; //eye ball Y
    ...
    void MouthOpening()
    {
        ...
        var parameter = model.Parameters[33]; //mouth open
    ...
    void MouthForm()
    {
        ...
        var parameter = model.Parameters[32]; //mouth form
